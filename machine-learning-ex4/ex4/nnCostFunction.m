...
for t=1:m,
	...
	delta_3 = a3 - y_binary(:,t); % y_binary trick - getting columns of t element
	...
	Theta1_grad = Theta1_grad + delta_2 * a1; % I don't know why a1 doesn't need to be transposed (brute force try)
